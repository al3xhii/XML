 ...
 * @author Kaco
 */
@WebServlet(name="ChampionServlet", urlPatterns={"/ChampionServlet"})
public class ChampionServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String XSLFileName = path + "/champion.xsl";

    
            String champName = request.getParameter("name");
            ...
            NodeList eventNodeList = doc.getElementsByTagName("champion");
            ...
            for (int i=0;i<num_events; i++){
                ...
                String eventNameValue = nameTextNode.getNodeValue();
                 if (champName.equals(eventNameValue)) {
                    ...
                    optimusPrime.setParameter("vChampionName", champName);
